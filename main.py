...
from models import resnet, shufflenet, shufflenetv2, mobilenet, mobilenetv2, video_swin_transformer, cvt2
import ast
import numpy as np
...
def train(train_normal_loader, train_anormal_loader, model, model_head, nce_average, criterion, optimizer, epoch, args,
          batch_logger, epoch_logger, memory_bank=None): #lesa
    losses = AverageMeter()
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        if args.model_type == 'resnet':
            ...
            model_head = cvt2.ProjectionHead(args.feature_dim)
        if args.use_cuda:
            model_head.cuda()
